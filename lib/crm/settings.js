...
export function applyCrmSettingsToConfig(config, settings) {
  ...
  return {
    ...
    chatwoot: {
      ...(config.chatwoot || {}),
      orderConfirmationEnabled: automation.whatsappOrderConfirmationEnabled,
      orderConfirmationEnabledAt: automation.whatsappOrderConfirmationEnabledAt,
      inboxId: automation.whatsappInboxId,
      orderTemplateName: automation.whatsappOrderTemplateName,
      orderTemplateLanguage: automation.whatsappOrderTemplateLanguage,
      orderTemplateCategory: automation.whatsappOrderTemplateCategory
    },
    delhivery: {
      ...config.delhivery,
