export const ROLE_TEMPLATES = {
  admin: ['*'],
  operations_manager: ['dashboard.view','orders.view','orders.edit','shipments.view','shipments.edit','printing.view','printing.edit','abandoned_carts.view','abandoned_carts.edit','tasks.view','tasks.edit','automation.view','automation.run','integrations.view','integrations.manage','settings.view','settings.manage'],
  packing_operator: ['dashboard.view','orders.view','shipments.view','shipments.edit','printing.view','printing.edit','tasks.view','tasks.edit'],
  support_operator: ['dashboard.view','orders.view','orders.edit','abandoned_carts.view','abandoned_carts.edit','tasks.view','tasks.edit','printing.view'],
  viewer: ['dashboard.view','orders.view','shipments.view','printing.view','abandoned_carts.view','tasks.view','automation.view','integrations.view','settings.view'],
...
export const PERMISSION_GROUPS = [
  ['dashboard','Dashboard',['view']], ['orders','Orders',['view','edit']], ['shipments','Shipments',['view','edit']], ['printing','Printing',['view','edit']], ['abandoned_carts','Abandoned carts',['view','edit']], ['tasks','Tasks',['view','edit']], ['automation','Automation',['view','run']], ['integrations','Integrations',['view','manage']], ['settings','Settings',['view','manage']], ['finance','Finance',['view','edit']], ['inventory','Inventory',['view','edit']], ['manufacturing','Manufacturing',['view','edit']]
];
...
export function permissionForPath(pathname, method = 'GET') {
  ...
  if (pathname.startsWith('/gst-invoices') || pathname.startsWith('/api/crm/gst-invoices')) return 'orders.view';
